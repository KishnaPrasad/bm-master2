...
try {
    ...
    private void setMarker(DataSnapshot dataSnapshot) {
        ...
        try {
          ...
          //  String latti = (String)dataSnapshot.child("latitude").getValue();
          //  String longi = (String)dataSnapshot.child("longitude").getValue();
           double lat = Double.parseDouble(Objects.requireNonNull(value.get("latitude")).toString());
            double lng = Double.parseDouble(Objects.requireNonNull(value.get("longitude")).toString());

//            double lat = Double.parseDouble(latti);
