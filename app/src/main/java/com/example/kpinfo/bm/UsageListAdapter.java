...
public class UsageListAdapter extends RecyclerView.Adapter<UsageListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            mPackageName = (TextView) v.findViewById(R.id.qtextview_package_name);
            mLastTimeUsed = (TextView) v.findViewById(R.id.qtextview_last_time_used);
            mAppIcon = (ImageView) v.findViewById(R.id.app_icon);
            mTimeinForeground = (TextView) v.findViewById(R.id.qtextview_Total_Time_in_Foreground);
        }
